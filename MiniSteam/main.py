import time, network, socket, rp2, sys, requests, json, gc, datetime, ubinascii
...
# WiFi:
# Niet veranderen aub, dit zorgt er gewoon voor dat hij vanaf het begin begint.
NetworkTry = 1
...
# Dit kan je aanpassen naar je eigen link maar dit is al de main link.
...
def RecentGames():
    ...
    try:
        ...
        display.text(fontSmall,"Error. Heb je recent",10,10,fgColor, bgColor)
